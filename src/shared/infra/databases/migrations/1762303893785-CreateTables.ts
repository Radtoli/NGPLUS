...
export class CreateTables1762303893785 implements MigrationInterface {
    name = 'CreateTables1762303893785'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "media_contents" ("media_id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying NOT NULL, "description" text NOT NULL, "category" character varying NOT NULL, "thumbnail_url" character varying NOT NULL, "content_url" character varying NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_0427ae0bfa5dc2703daee079272" PRIMARY KEY ("media_id"))`);
